...
def calculate_metrics_graphs(G, G_second, alpha, fname='foobar.html', algo='louvain', viz=True, average=10):
    ...
    for i in range(average):
        ...
        attr_modularity_list[i] = community.modularity(partition, G_second, weight='weight')
        diff_mod_list_1[i] = calc_diff_first_theorem(partition, G, G_second, G_w, alpha)
        diff_mod_list_2[i] = calc_diff_second_theorem(clusters, G, G_second, G_w, alpha)
    ...
    return metrics_report, clusters, G, partition
